    ...
    <div className="mt-2 px-6 w-[100%] overflow-x-hidden">
      ...
      <nav className="flex justify-center items-center mb-16">
        <ul className="flex gap-1.5 md:gap-5 lg:gap-5 items-center">
          <li className="md:mr-5 lg:mr-5 mr-1 text-[0.6rem] md:text-[0.75rem] lg:text-[0.85rem] cursor-pointer text-slate-300 font-manropeEL" onClick={prevPage}>
            Previous
          </li>
          ...
          <li className="md:ml-5 lg:ml-5 ml-1 text-slate-300 text-[0.6rem] md:text-[0.75rem] lg:text-[0.85rem] cursor-pointer font-manropeEL" onClick={nextPage}>
            Next
          </li>
        </ul>
      </nav>
