...
import useVendorDetailLogic from './useVendorDetailLogic';
...
function VendorDetails(): React.ReactElement {
  ...
  const { nextPage, currentPage, changeCPage, prevPage, firstIndex, lastIndex, numbers } = useVendorDetailLogic(id);
