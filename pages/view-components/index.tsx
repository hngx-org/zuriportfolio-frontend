...
const CardHover: React.FC<CardHoverProps> = ({ setOpenCard, openCard }) => {
  return (
    <div
      className={`absolute z-[6]  border-1 bg-[#fff] border m-auto  w-[389px]  rounded-xl justify-center overflow-hidden ${
        openCard ? 'h-[451px]' : 'h-0'
      } items-center transition-all top-0 left-0`}
    >
        ...
        <div className=" px-8 py-4 flex items-start justify-between w-100">
          <div className="w-50">
            ...
            <div className="sm:grid  sm:grid-cols-3">
              <button className="mt-2  border text-[70%] border-white-100 text-white-500  py-1 rounded-full">
                UI Design
              </button>
              <button className="mt-2  ml-4 text-[70%] text-white-500 border border-white-100 py-1 rounded-full">
                User Research
              </button>
              <button className="mt-2  ml-4 text-[70%] text-white-500 border border-white-100  py-1 rounded-full">
                Prototyping
              </button>
              <button className="mt-2  text-[70%] border text-white-500 border-white-100  py-1 rounded-full">
                Figma
              </button>
              <button className="mt-2  text-[70%] ml-4 border text-white-500 border-white-100  py-1 px-1 rounded-full">
                Interaction Design
              </button>
              <button className="mt-2 text-[70%]  ml-4 border text-white-500 border-white-100  py-1 rounded-full">
                +5
              </button>
            </div>
          </div>
