...
const AccessDenied = () => {
  return (
    <div className=" bg-white-100 min-h-screen">
      ...
      <div
         className=" flex flex-col-reverse gap-9 sm:gap-[72px] min-h-[calc(100vh-105px)] max-w-[1240px] 
         mx-6 sm:mx-[105] xl:mx-auto items-center justify-between xl:flex-row xl:gap-[162px]"
         >
