          ...
          <form onSubmit={handleSubmit}>
            <div>
              <div className="md:flex md:gap-10 gap-7">
                <div className="flex flex-col">
                  <label className="text-[#344054] font-manropeB text-[14px]">Discount Type</label>
                  <select
                    className="border-solid border-[2px] border-white-400 text-dark-600 py-3 text-[14px] rounded-lg mt-3 text-left pl-2 pr-20 hover:border-[#009254]"
                ...
                <div className="md:mt-0 mt-6 ">
                  <label className="text-[#344054] font-manropeB text-[14px]">Amount</label>
                  <Input className="w-full text-[14px] mt-2" placeHolder="e.g 12%" />
                </div>
                <div className="md:mt-0 mt-6 ">
                  <label className="text-[#344054] font-manropeB text-[14px]">Limit/Quantity</label>
                  <Input className="w-full text-[14px] mt-2" placeHolder="e.g 2" />
                </div>
              </div>
              <div className="mt-7">
                <label className="text-[#344054] font-manropeB text-[14px]">Maximum Discount (optional)</label>
              ...
              <div className="flex flex-col w-full">
                <label className="text-[#344054] mt-7 font-manropeB text-[14px]">Select Product/Collection</label>
                <select
                  className="border-solid border-[2px] border-white-400 text-dark-600 py-3 text-[14px] rounded-lg mt-3 text-left pl-2 pr-20 hover:border-[#009254]"
                  value={selectedOption}
                  onChange={handleOptionChange}
              ...
              <div className="md:flex md:gap-10 gap-6 mt-7 w-full">
                <div className="flex flex-col w-full">
                  <label className="text-[#344054] font-manropeB text-[14px]">Valid From</label>
                  <input
                    className="border-solid border-[2px] border-white-400 text-dark-600 py-3 text-[14px] rounded-lg mt-3 text-left pl-2 pr-10 hover:border-[#009254] datepickerbg"
                    type="datetime-local"
                ...
                <div className="flex flex-col w-full md:mt-0 mt-6 ">
                  <label className="text-[#344054] font-manropeB text-[14px]">Valid To</label>
                  <input
                    className="border-solid border-[2px] border-white-400 text-dark-600 py-3 text-[14px] rounded-lg mt-3 text-left pl-2 pr-10 hover:border-[#009254]"
                    type="datetime-local"
            ...
            <div>
              <Link href="/promotions">
                <button className="w-full bg-[#009254] text-white-100 p-3 mt-5 rounded-lg" type="submit">
                  Create Discount
                </button>
              </Link>
              <button className="w-full border text-[#009254] border-[#009254] p-3 mt-5 rounded-lg" type="submit">
                Save Draft
              </button>
            </div>
          </form>
