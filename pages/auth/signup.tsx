      ...
      <div className="mt-6 md:mt-12">
        <form className="flex flex-col">
          <div className="flex flex-col gap-2 mb-2">
            ...
            <Input placeHolder="Aliu" id="firstname" name="firstname" className="w-full border-[#D0D5DD]" type="text" />
          </div>
          <div className="flex flex-col gap-2 mb-2">
            <label htmlFor="lastname" className="leading-[27.04px] font-semibold text-gray-700">
              Last name
            </label>
            <Input placeHolder="Sugar" id="lastname" name="lastname" className="w-full border-[#D0D5DD]" type="text" />
          </div>
          <div className="flex flex-col gap-2 mb-2">
          ...
          <div className="flex items-center leading-[27.04px] my-4 h-5">
            <span className="mr-2 flex my-auto ">
              <input type="checkbox" name="checkbox" className="w-4 border-brand-green-primary" />
            </span>
