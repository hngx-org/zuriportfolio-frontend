  ...
  return (
    <>
      <Head>
        ...
        {/* SEO Stuff start */}
        <title>Continue Signup - Zuri Portfolio</title>
        ...
        <meta
          ...
          name="description"
          content="Continue signup for your Zuri Portfolio."
        />
        <meta name="keywords" content="Zuri, Portfolio, Continue Signup" />
        ...
        <meta key="twitter:description" name="twitter:description" content="Continue signup for your Zuri Portfolio." />
        <meta key="twitter:image" name="twitter:image" content="https://staging.zuri.team/auth/continue-signup" />
        ...
        <meta property="og:description" content="Continue signup for your Zuri Portfolio." />
              ...
              <form className="flex flex-col" onSubmit={form.onSubmit((values) => handleSignUp(values))}>
                ...
                <div className="flex flex-col gap-2 mb-2">
                  <label
                    ...
                    className="font-manropeL leading-[27.04px] font-semibold text-gray-700"
                  >
                    Confirm password
                  </label>
                  <Input
