...
const AccessDenied = () => {
    return (
        <div className=" bg-white-100 min-h-screen">
            ...
            <div className=" flex flex-col-reverse gap-9 sm:gap-[72px] md:gap-[96px] min-h-[calc(100vh-105px)] max-w-[1240px] 
      mx-6 sm:mx-[105] xl:mx-auto items-center justify-center xl:flex-row xl:gap-[162px]">
                <div className="flex flex-col gap-[24px] sm:items-center xl:items-start max-w-[504px] items-center ">
                    <div className="flex flex-row space-x-2 gap-1">
                        <h2 className="text-2xl md:text-[32px] xl:text-[45px] md:leading-[36px] xl:leading-[52px] sm:font-bold xl:text-left max-w-[504px] text-center font-semibold font-manropeL xl:font-manropeB">Access Denied</h2>
                    ...
                    <p className=" text-[#737876] max-w-[623px]  text-sm sm:text-2xl sm:left-8 sm:text-[#8D9290] text-center xl:text-left ">
                        Whoa there, hold on! It looks like this area is off-limits. Our
                        virtual police officer is here to ensure your safety and privacy.
                        You might need special credentials or permissions to enter this zone
                    </p>
                    <Link href={'/'}>
