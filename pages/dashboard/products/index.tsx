  ...
  return (
    <MainLayout showDashboardSidebar={true} activePage="products" showTopbar={true}>
      <div className="max-w-[1240px] mx-auto my-4">
        ...
        <div
          className="max-w-[1226px] mx-auto rounded-2xl px-[15px] py-[13px]"
          style={{
        ...
        >
          <div className="flex gap-5 justify-between mb-[37px]">
            <div
              className="focus-within:outline max-w-[785px] focus-within:outline-black px-[14px] py-[10px] flex gap-2 items-center border border-slate-50 rounded-lg flex-1 "
              style={{
