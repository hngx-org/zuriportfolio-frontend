  ...
  return (
    <div className="">
      <MainLayout activePage="Explore" showDashboardSidebar={false} showTopbar={true}>
        <div className="max-w-[1240px] hidden xl:block mx-auto my-0">
          <CategoriesNav
            navItems={[
              ' Design & Graphics',
            ...
            <div className=" flex items-center justify-center">
              <div className="  mb-10 items-center justify-center">
                <div className=" lg:text-2xl lg:leading-8 text-custom-color31 font-manropeB lg:font-semibold text-[22px] leading-7 ">
                  <p className="">Customer Feedback</p>
                </div>
                ...
                <div className="flex flex-col   md:flex-row md:items-start items-center justify-center">
                  <div className=" flex-col items-center hidden md:block   py-4 ">
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center w-48">
                        <Link href="product-details" className="flex items-center">
                          <p className=" font-bold font-manropeL lg:text-base lg:leading-6 text-green-600 tracking-wide cursor-pointer items-center flex p-0 text-xs leading-6 tracking-tight ">
                            See more reviews
                          </p>
