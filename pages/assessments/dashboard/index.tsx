        ...
        <div className='px-2'>
          ...
          <div className='md:flex'>
            {LevelData().map((item, index) => (
              <div key={index} className='flex md:mx-3 items-center gap-4 border md:border-[1px] border-[2px] my-[2.5rem] border-white-400 px-3 rounded-md h-[11rem]'>
                ...
                <div>
                  <p className='text-brand-green-shade10 font-medium text-[1.5rem] md:text-[1rem] lg:text-[1.5rem] leading-1'>Level: {item.level}</p>
