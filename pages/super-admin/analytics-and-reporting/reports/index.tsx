                ...
                <div className="flex justify-center flex-col gap-[2.88rem] m-[1.88rem] max-[768px]:m-[0.27rem] max-[768px]:gap-[1.27rem]">
                  ...
                  <div className="flex flex-col gap-[1.02rem] max-[768px]:gap-[0.85rem]">
                    ...
                    <div className="flex justify-evenly">
                      ...
                      <div className="flex justify-center items-center max-w-[9.59425rem] w-full font-manropeL rounded-[0.95944rem] py-[1.2rem] focus:bg-[#E6F5EA] shadow-[0px_1.91885px_3.83771px_0px_rgba(16,24,40,0.05)] text-[1.9188rem] text-center leading-[2.87825rem] tracking-[0.00288rem] text-[#8D9290] border-gray-300 hover:bg-[#E6F5EA] hover:text-[#009254] hover:border hover:border-[#33A467] max-[768px]:text-[0.84725rem] max-[768px]:w-[4.23625rem] max-[768px]:py-[0.74rem] focus:text-[#009254] focus:border focus:border-[#33A467] max-[768px]:leading-[1.278rem] cursor-pointer">
                        PDF
                      </div>
                      <div className="flex justify-center items-center max-w-[9.59425rem] w-full font-manropeL rounded-[0.95944rem] py-[1.2rem] text-[#8D9290] border-gray-300 shadow-[0px_1.91885px_3.83771px_0px_rgba(16,24,40,0.05)] text-[1.9188rem] text-center leading-[2.87825rem] tracking-[0.00288rem] hover:text-[#009254] hover:bg-[#E6F5EA] focus:bg-[#E6F5EA] hover:border hover:border-[#33A467] max-[768px]:text-[0.84725rem] max-[768px]:w-[4.23625rem] max-[768px]:py-[0.74rem] max-[768px]:leading-[1.278rem] focus:text-[#009254] focus:border focus:border-[#33A467]  cursor-pointer">
                        CSV
                      </div>
                    </div>
                  </div>
