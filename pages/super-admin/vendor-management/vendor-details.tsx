...
import { vendorInstance } from '../../../http/axios';
...
const banVendor = async (id: number) => {
  try{
        ...
        <div className="profile mt-10  w-full lg:w-1/2 lg:ml-12 lg:mr-5 lg:mt-0">
          ...
          <div className="bio">
            <div className="rating flex items-center justify-between mr-3 mb-3">
              ...
              <p className="text-xs mr-5 lg:mr-0 sm:ml-auto">{!isLoading ? (`Date Added ${data?.joined_date}`) : "Loading..."}</p>
            </div>
