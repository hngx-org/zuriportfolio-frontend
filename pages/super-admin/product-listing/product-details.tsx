...
const productsDetail = () => {
  return (
    <div className="lg:max-w-[1240px] max-w-[327px] md:max-w-[754px] m-auto ">
      <Navbar />
      ...
      <div className="flex gap-[28px] flex-col lg:flex-row">
        <div className="flex flex-col mt-6 gap-[16px] lg:w-1/2">
          <Image
            src={mainImage}
            alt="Main Image"
            className="lg:w-[607px] lg:h-[432px] md:w-[754px] w-[327px]  lg:object-cover object-contain rounded-2xl"
          />
          <Slider />
        </div>
