          ...
          <div className="">
            <div className="">
              {workExperiences.map((experience, index) => {
                // const isLastElement = index === workExperiences.length - 1;
                return (
                  <article
                  ...
                  >
                    <div className="flex justify-between">
                      ...
                      <div className="flex gap-10">
                        <p className="text-[#8D9290] font-semibold font-manropeL">
                      ...
                      <div className="font-semibold font-manropeL text-[#737876]">{experience.description}</div>
                      {/* </div> */}
                    </div>
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col gap-[.5rem] w-[90%]">
                ...
                {/* <input
                  ...
                  type="text"
                  className="h-[44px] outline-none border-[#E1E3E2] border-2 focus:border-brand-green-primary pl-2 rounded-lg border-solid w-full"
                /> */}
                <Input
                  placeHolder=""
                  onChange={(e) => {
