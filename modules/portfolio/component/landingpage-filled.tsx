...
const LandingPageFilled: React.FC = () => {
  return (
    <div className="flex flex-col gap-20 w-[100%] overflow-hidden">
      ...
      <div className="flex flex-col gap-4 items-start mx-24 w-[90%]">
        <div className="flex flex-row justify-between mb-2 items-center relative w-[100%]">
        ...
        <div className="font-['Manrope'] tracking-[0.08] leading-[24px] text-[#737876] self-end mb-4 w-[100%]">
        ...
        />
        <div className="flex flex-row justify-between mb-2 items-start w-[100%]">
          <div className="flex flex-row gap-3 items-start">
            <Image
              src="/assets/images/landingPageFilled/menu.svg"
              id="Vuesaxboldmenu2"
            ...
            <div
              id="Experience4"
              className="border-solid border-[#009254] flex flex-col justify-center w-[80%] shrink-0 h-16 items-start border-t-0 border-b-4 border-x-0"
            >
              <div className="text-2xl font-['Manrope'] font-bold leading-[32px] text-[#2e3130] w-[70px]">
                Work Experience
              </div>
            </div>
          </div>
        ...
        <div className="bg-white flex flex-row justify-between items-end mb-4 mr-px rounded-lg w-[100%]">
          <div className="flex flex-col gap-2 items-start w-1/2">
            ...
            <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#009254] mb-8 ml-[60%] hidden sm:flex">
              Senior product designer
            </div>
            <div className="flex flex-row justify-between ml-8 mr-2 w-[409px] items-start">
              <div className="font-['Manrope'] font-semibold tracking-[0.08] leading-[24px] text-[#8d9290]">
                May 2021 - Present
              </div>
              <div className="text-xl font-['Manrope'] font-semibold leading-[28px] text-[#2e3130]">
            ...
            <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#009254] ml-[60%] hidden sm:flex">
              Senior product designer
            </div>
          </div>
          <div className="flex flex-col gap-6 items-end w-1/2 hidden sm:flex">
            
            <div className="font-['Manrope'] font-semibold tracking-[0.08] leading-[24px] text-[#737876] md:text-sm">
        ...
        <div className="flex flex-row gap-16 items-start mb-2 ml-8 w-[100%]">
          <Image
          ...
          <div className="flex flex-col justify-between gap-6 w-[70%] items-start">
            <div className="flex flex-col gap-3 items-start">
              ...
              <div className="font-['Manrope'] font-semibold tracking-[0.08] leading-[24px] text-[#737876] w-[100%]">
                Implemented A/B testing for website redesign, leading to a 40%
                improvement in user retention and a 25% increase in conversion
                rates, ultimately resulting in a 20% boost in overall revenue.
              </div>
            </div>
            <div className="flex flex-row justify-between items-start sm:flex w-[10%] m-[0]">
              <div className="border-solid border-[#8d9290] flex flex-col w-16 shrink-0 items-center px-4 py-1 border rounded-[24px] m-3 sm:flex m-[0]">
              ...
              <div className="border-solid border-[#8d9290] flex flex-col w-20 shrink-0 items-center px-4 py-1 border rounded-[24px] m-3 sm:flex m-[0]">
                <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#444846]">
                  Sketch
                </div>
              </div>
              ...
              <div className="border-solid border-[#8d9290] flex flex-col w-24 shrink-0 items-center px-4 py-1 border rounded-[24px] m-3 hidden sm:flex m-[0]">
                <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#444846]">
                  Adobe XD
                </div>
              </div>
              ...
              <div className="border-solid border-[#8d9290] flex flex-col w-16 shrink-0 items-center px-4 py-1 border rounded-[24px] m-3 hidden sm:flex m-[0]">
                <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#444846]">
                  Miro
                </div>
              </div>
        ...
        <div className="flex flex-row gap-16 items-start mb-4 mx-8 sm:flex-row">
          <Image
            src="/assets/images/landingPageFilled/imageplace.png"
            ...
            className=""
          />
          <div className="flex flex-col justify-between gap-6 w-[70%] items-start order-2 sm:order-none sm:flex w-[40%]">
            <div className="flex flex-col gap-3 items-start">
              <div className="text-xl font-['Manrope'] font-semibold leading-[28px] text-[#2e3130]">
                Byte financiap LandingPageFilled
              </div>
            ...
            <div className="flex flex-row justify-between items-start sm:flex sm:text-s">
              <div className="border-solid border-[#8d9290] flex flex-col w-16 shrink-0 items-center px-4 py-1 border rounded-[24px] m-3 sm:flex m-[0]">
                <div className="text-sm font-['Manrope'] tracking-[0.04] leading-[20px] text-[#444846]">
                  UI/UX
                </div>
        ...
        <div className="bg-white flex flex-row gap-2 items-end mb-4 mr-px rounded-lg w-[100%]">
          
          <div className="flex flex-col ml-[45px] mr-[100px] mb-10 gap-16 items-start">
          ...
          <div className="flex flex-col gap-10 items-start mr-20">
          ...
          <div className="flex flex-col gap-6 w-1/2 items-end hidden sm:flex">
        ...
        <div className="flex flex-row justify-between w-1/2 items-start mb-3 ml-8">
          ...
          >
            <div
              id="Text1"
              className="font-['Manrope'] font-semibold tracking-[0.08] leading-[24px] text-[#737876] mx-4 m-3"
            >
              Graphic Design
            </div>
          </div>
        ...
        <div className="flex flex-row justify-between items-start mb-3 ml-8 mr-[366px]">
          <div
            id="Tag4"
            className="border-solid border-[#e1e3e2] bg-white flex flex-col justify-center h-12 items-center border rounded-[24px] m-3 sm:flex m-[0]"
          >
            <div
              id="Text5"
              className="font-['Manrope'] font-semibold tracking-[0.08] leading-[24px] text-[#737876] mx-4"
