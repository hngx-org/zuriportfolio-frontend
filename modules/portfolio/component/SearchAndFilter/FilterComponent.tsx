...
const FilterComponent: React.FC = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 w-[90vw] mx-auto my-8 lg:grid-cols-6 sm:grid-cols-2 justify-center lg:flex lg:justify-between lg:w-[1240px]">
        <CustomDropdown
