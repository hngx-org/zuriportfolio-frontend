      ...
      <div className="mt-6 md:mt-12">
        <form className="flex flex-col">
          <div className="flex flex-col gap-2 mb-2">
            <label htmlFor="firstname" className="leading-[27.04px] font-medium text-gray-600">
              First name
            </label>
            <Input
              placeHolder="Aliu"
          ...
          <div className="flex flex-col gap-2 mb-2">
            <label htmlFor="lastname" className="leading-[27.04px] font-medium text-gray-600">
              Last name
            </label>
            <Input placeHolder="Sugar" id="lastname" name="lastname" className="w-full font-bold rounded" type="text" />
          </div>
          <div className="flex flex-col gap-2 mb-2">
            <label htmlFor="password" className="leading-[27.04px] font-medium text-gray-600">
              Password
            </label>
            <Input
              ...
              rightIcon={
                <TogglePasswordVisibilityButton isVisible={passwordVisible} onToggle={togglePasswordVisibility} />
              }
            />
          </div>
          <div className="flex flex-col gap-2 mb-2">
            <label htmlFor="confirmPassword" className="leading-[27.04px] font-medium text-gray-600">
              Confirm password
            </label>
            <Input
              placeHolder="Gbemi345"
          ...
          <Button intent={'primary'} size={'sm'} className="w-full rounded" type="submit">
            Continue
          </Button>
        </form>
        <div className="mt-8">
...
const TogglePasswordVisibilityButton: React.FC<{ isVisible: boolean; onToggle: () => void }> = ({
  isVisible,
  onToggle,
}) => {
  return (
