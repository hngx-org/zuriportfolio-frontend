  ...
  return (
    <div className="h-[56px] bg-blue-250 w-full flex justify-center items-center">
      <div className="flex justify-center items-center p-[10px]">
        <div className=" hidden text-white-100 p-4 md:h-[30px] md:flex md:justify-center md:items-center md:bg-green-200 md:rounded-[10px] md:hover:bg-green-200 md:mr-2 ">
          FEATURED
        </div>
