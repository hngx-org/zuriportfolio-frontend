...
const DynamicCategoryCarousel = () => {
  ...
  useEffect(() => {
    const fetchCategoryNames = async () => {
      try {
        const categoriesResponse = await axios.get('https://coral-app-8bk8j.ondigitalocean.app/api/marketplace/categoryNames/');
    ...
    const fetchProducts = async (category: string) => {
      try {
        const response = await axios.get(`https://coral-app-8bk8j.ondigitalocean.app/api/marketplace/products/${category}`);
