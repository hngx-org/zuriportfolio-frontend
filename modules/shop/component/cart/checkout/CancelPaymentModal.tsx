    ...
    modalOpen && (
      ...
      <div className="bg-[#fff] rounded-[20px] w-full lg:w-[572px] flex flex-col gap-[24px] items-center justify-center lg:px-[73px] lg:py-[50px]">
          ...
          <div className="btns w-full flex gap-[78px] justify-center items-center">
            <button    onClick={() => setModalOpen(false)} className=' w-[189px] h-[56px]  font-bold text-[14px] font-manropeL leading-[20px] text-[#808080]'>No, Back</button>

            <button className=' text-[#fff] rounded-[10px] font-manropeL font-[600] text-[14px] leading-[20px] bg-brand-green-primary w-[189px] h-[56px] px-[20px] py-[12px]'>Yes, Cancel</button>
          </div>
        </div>
      </>
