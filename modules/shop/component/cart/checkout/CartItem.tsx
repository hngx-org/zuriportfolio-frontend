  ...
  return (
    <div className="flex flex-col md:flex-row md:flex-wrap gap-x-8 w-full border-t border-[#efeff4] py-5 px-5">
      ...
      <div className=" mt-3 md:ml-auto md:flex md:items-center">
        <Button className="bg-[#fff] ml-auto md:mr-0 flex border px-5 gap-1 items-center justify-center shadow-md w-[100px] h-[40px] border-[#d5dbdd] rounded-md cursor-pointer" 
