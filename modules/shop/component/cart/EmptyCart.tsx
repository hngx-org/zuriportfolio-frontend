        ...
        <>
         ...
         <div className='px-[100px] pt-[211px] pb-[72px] flex flex-col gap-[32px] items-center justify-center'>
             <div className='heading flex flex-col items-center gap-[8px]'>
                 ...
                 <p className='text-[16px] font-[700] leading-[24px] font-manropeL text-[#737876]'>Looks like you haven’t added anything to Your Cart yet</p>
          ...
          <div className='help-line border-y border-[#E1E3E2] px-[100px] py-[24px] w-full'>
            <p className='font-manropeL text-[16px] font-[400] leading-[24px] w-[1240px]'>Need some help? <a href='#' className='text-[#009254] font-[600]'>Chat now </a>or call +234-8zuri-store</p>
         </div>
