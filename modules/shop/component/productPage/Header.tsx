...
import notificationIcon from '../../../../components/Navbars/assets/notification.svg';
import cartIcon from '../../../../components/Navbars/assets/shopping-cart.svg';
import briefCaseIcon from '../../../../components/Navbars/assets/briefcase.svg';
import dashBoard from '../../../../components/Navbars/assets/home-2.svg';
  ...
  return (
    <>
      <nav className="w-full py-6  bg-white-100 border-b border-[#EBEEEF] justify-between items-center px-4  z-[40] isolate sticky top-0  ">
        <div className="container mx-auto  px-4 sm:px-6 md:px-6 lg:px-10 flex items-center justify-between  relative gap-1">
