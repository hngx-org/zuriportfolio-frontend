        ...
        <div className="max-w-[77.5rem] w-full mt-[3rem] min-[1536px]:max-w-[1536px] flex flex-col gap-[0.9375rem] rounded-[0.5rem] border border-[#E1E3E2] bg-[#FFF] mx-auto max-[730px]:max-w-[100%] max-[760px]:rounded-tr-none max-[760px]:rounded-br-none max-[760px]:border-r-0">
          ...
          <div className="w-full">
            <div className="max-[778px]:overflow-x-scroll no-scrollbar">
              <div className="flex items-center justify-between gap-[1.5rem] py-[0.75rem] pb-0 border-[#EAECF0] max-[730px]:flex max-[778px]:pr-0 max-[1110px]:gap-0 max-[778px]:w-fit">
                <div className="flex items-center gap-[0.25rem] border-b-[#EAECF0] border-b-[0.0625rem] pl-[1.5rem] py-[0.75rem] bg-[#FCFCFD] max-w-[10rem] w-full max-[778px]:min-w-[5rem] max-[834px]:text-[0.75rem]">
                ...
                {/* <div className="max-w-[8.56rem] w-full py-[0.75rem] bg-[#FCFCFD] max-[778px]:min-w-[8.56rem]">
                  <p className="text-[0.875rem] text-center font-manropeL text-[#667085] font-normal leading-[1.25rem] tracking-[0.00088rem] max-[834px]:text-[0.75rem]">
                    Total Users
                  </p>
                </div> */}
                ...
                performanceDataArray?.map((performance: any) => {
                  return (
                    <div
                      ...
                      className="flex items-center justify-between gap-[1.5rem] py-[1rem] bg-[#FFF] max-[730px]:flex max-[730px]:pr-0 max-[1110px]:gap-0 max-[778px]:w-fit max-[778px]:pr-0"
                    >
                      <div className="max-w-[10rem] pl-[1.5rem] w-full max-[778px]:min-w-[5rem]">
