  ...
  return (
    <>
      <div key={data.id} className={`${showItems ? 'block' : 'hidden'}`}>
        <div className="flex items-center pl-[1.5rem] pr-[1rem] py-[1rem] min-[1536px]:justify-between max-[950px]:pr-[2rem] max-[950px]:w-fit">
          ...
          <div className="flex justify-between items-center max-w-[51.3rem] w-full gap-[1.25rem] px-[1.5rem] min-[1536px]:gap-0 min-[1536px]:px-0 max-[834px]:pl-0">
