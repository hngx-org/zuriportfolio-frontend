...
const ReportRedirect: React.FC = () => {
  ...
  return (
    <>
      <div className="ml-[6.25rem] max-[1000px]:mr-[2rem] max-[1300px]:ml-[1.75rem] max-w-[77.5rem] w-full max-[500px]:ml-[1.5rem] max-[1300px]:mx-auto max-[1300px]:px-[1rem]">
        ...
        <div className="flex gap-[1.5rem] items-center max-[768px]:flex-col max-[768px]:items-stretch mt-[1.25rem] max-[834px]:gap-0 max-[768px]:gap-[1.5rem]">
          ...
          <div className="flex gap-[1.5rem] max-[375px]:justify-between max-[834px]:pl-[1.5rem] max-[834px]:gap-[1.5rem] max-[800px]:pl-[1rem] max-[800px]:gap-[1rem] max-[768px]:gap-[1.5rem] max-[768px]:pl-0">
            ...
            <div
              onClick={() => openModal()}
              className="w-[9.6875rem] p-[0.75rem] flex justify-center items-center rounded-[0.5rem] bg-[rgba(210,255,231,0.15)] border border-[#009254] tracking-[0.005rem] text-[1rem] leading-[1.5rem] font-manropeL text-[#386A20] font-normal max-[850px]:w-[8.375rem] max-[500px]:py-[0.5rem] max-[500px]:p-[0.5rem] max-[375px]:text-[0.875rem]"
            >
              {isLoading ? (
          ...
          >
            <div className="flex justify-center flex-col gap-[2.88rem] m-[1.88rem] max-[768px]:m-[0.27rem] max-[768px]:gap-[1.27rem]">
              ...
              <div className="flex justify-evenly">
                ...
                <div className="flex justify-center items-center bg-[#F4FBF6] border-[1.919px] border-[#009254] rounded-[1.91888rem] max-w-[17.50956rem] w-full h-[5.75656rem] font-manropeL text-[#009254] text-[1.5rem] font-extrabold tracking-[0.00088rem] leading-[1.375rem] max-[768px]:text-[0.875rem] max-[768px]:w-[7.73119rem] max-[768px]:h-[2.5rem]">
                  Cancel
                </div>
              </div>
            </div>
