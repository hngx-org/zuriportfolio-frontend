...
const SuperAdminDeletedVendorsHeader = () => {
  return (
    <Head>
      ...
      />
      <meta name="title" property="og:title" content="Deleted Vendors Details" />
      ...
      {/* Twitter tags */}
      <meta name="twitter:card" content="Deleted Vendors Details" />
      <meta name="twitter:title" content="Deleted Vendors Details" />
      <meta
...
export default SuperAdminDeletedVendorsHeader;
