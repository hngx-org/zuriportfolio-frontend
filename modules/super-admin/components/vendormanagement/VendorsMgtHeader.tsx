...
const SuperAdminVendorManagementHeader = () => {
  return (
    <Head>
      ...
      />
      <meta name="title" property="og:title" content="Vendor Details" />
      ...
      {/* Twitter tags */}
      <meta name="twitter:card" content="Vendor Details" />
      <meta name="twitter:title" content="Vendor Details" />
      <meta
...
export default SuperAdminVendorManagementHeader;
