...
const SuperAdminBannedVendorsHeader = () => {
  return (
    <Head>
      ...
      />
      <meta name="title" property="og:title" content="Banned Vendors Details" />
      ...
      {/* Twitter tags */}
      <meta name="twitter:card" content="Banned Vendors Details" />
      <meta name="twitter:title" content="Banned Vendors Details" />
      <meta
...
export default SuperAdminBannedVendorsHeader;
