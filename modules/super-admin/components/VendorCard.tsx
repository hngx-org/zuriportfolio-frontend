...
function VendorCard({ vendorname, pic, name, price }: VendorCardProps): React.ReactElement {
  return (
    <div className="rounded-md p-4 border-[#D5DBDD] border border-solid font-manropeA max-w-[250px]">
      ...
      <div className="flex flex-col w-[230px] max-w-[100%] content-start">
        <p className="text-[0.65rem] md:text-[0.75rem] lg:text-[0.85rem] break-words w-[100%] max-w-[100%] text-[#052011]">
          {name}
        </p>
        <h2 className="font-bold text-[#052011]">{`$${price}`}</h2>
        <p className="text-[#4F4E4E] font-semibold text-[0.65rem] md:text-[0.75rem] lg:text-[0.85rem] break-words w-[100%] max-w-[100%]">
          By:{' '}
      ...
      <div className="rating flex items-center gap-[2px] mt-6 w-[230px]">
        ...
        <Image src={Starempty} alt="star" className="w-[16px] h-[14px]" />
        <span className="font-bold text-[#4F4E4E]">(3)</span>
      </div>
    </div>
  );
}
