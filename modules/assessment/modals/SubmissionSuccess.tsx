  ...
  return (
    <div className="w-fit m-auto items-center font-manropeB justify-center px-8 sm:px-16 bg-white-100 rounded-[16px] py-16 sm:py-24 p-4 gap-3 flex flex-col">
      <div className="items-center justify-center m-auto align-middle  flex flex-col gap-8">
        ...
        <p className=" justify-center w-[70%] align-middle items-center text-center font-[600] text-[1.2em] ">
          Your answers have been successfully submitted and graded.
        </p>
        <button
          onClick={onClose}
          className="bg-brand-green-primary text-[1.1em] m-auto gap-4 px-2 items-center justify-center flex hover:bg-brand-green-hover focus:bg-brand-green-focused active:bg-brand-green-pressed text-white-100 py-3 rounded-[16px]"
        >
          Check my score
