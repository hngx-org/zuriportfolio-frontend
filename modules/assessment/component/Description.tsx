...
function Description({ info, number, icon }: any) {
  return (
    <div className="description flex border-[1px] border-[#A8ACAB] p-6 rounded-lg hover:text-[#005427] font-ManropeL items-center justify-between w-[291px]">
      <div>
        <div className="text-base uppercase">{info}</div>
        <div className="text-[#006F37]  text-[45px] leading-[53px] mt-2">{number}</div>
      </div>
