...
function AccountManagementMobile() {
  return (
    <div className="sm:w-[465px] flex flex-col mx-[24px] mt-[2rem] sm:ml-[73px] gap-y-[1rem] mb-[37px]">
      <h3 className=" font-manropeEB text-[1.375rem] text-[#2E3130] leading-[1.75rem]">Account Management</h3>
      <form className="flex flex-col gap-y-[2rem]">
        <div className="flex flex-col gap-y-[0.5rem]">
          <label htmlFor="email" className=" font-manropeEB text-[1rem] leading-[1.5rem] text-[#344054]">
            Email
          </label>
        ...
        <div className="flex flex-col gap-y-[0.5rem]">
          <label htmlFor="currentPassword" className=" font-manropeEB text-[1rem] leading-[1.5rem] text-[#344054]">
            Change Password
          </label>
          <div className="flex flex-col gap-y-[0.375rem]">
      ...
      <Button size="lg" intent="primary" className="w-full rounded-[0.5rem] py-[0.5rem] px-[1.25rem] mt-[2rem]">
        Confirm Changes
      </Button>
    </div>
  );
