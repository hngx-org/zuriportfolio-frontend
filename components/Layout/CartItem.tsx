...
export default function CartItem({productImage,productTitle,productSize,productColor,productSeller,productPrice}: CartItemProps) {
  return (
    <div className="flex flex-col md:flex-row md:flex-wrap gap-x-8 w-full border-t border-[#efeff4] py-5 px-5">
      ...
      <div className="flex flex-col mt-2 md:w-3/5">
        ...
        <p className="text-[#6c7983]">Size: {productSize}, Color: {productColor}, Material: Plastic Seller: {productSeller}</p>
      ...
      <div className=" mt-3 md:ml-auto md:flex md:items-center">
        ...
        rightIcon={<p className="text-[#555757]">Remove</p>} leftIcon={<img src="./assets/icons/trash.svg" alt="trash-icon" />}  > </Button>
      </div>
    </div>
  );
}
