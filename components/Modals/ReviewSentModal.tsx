        ...
        <Dialog as="div" className="fixed inset-0 z-50" onClose={closeOnOverlayClick ? closeModal : () => null}>
          ...
          <div className="fixed inset-0  flex items-center justify-center">
            ...
            >
              ...
              >
                <div className="mb-4 ">
                  <GrStar size={96} className="w-20 mx-auto flex justify-center align-center" />
                  {/* <i alt="Icon" className="w-20 mx-auto" />{' '} */}
                  {/* Replace with your image source */}
                </div>
                <h3 className="text-5xl font-medium leading-6 text-gray-900 py-4">Submitted</h3>
