...
function BadgeModal({ isOpen, onClose, badgelabel, scorePercentage }: ModalProps) {
      ...
      <div className="bg-white rounded-lg mx-auto flex flex-col gap-[22px] items-center">
        <div ref={downloadRef} className="p-8 flex flex-col gap-8 items-center justify-center">
          ...
          <div className="flex gap-2 items-center">
            <h4 className="font-manropeB font-[600] text-[28px] text-xl capitalize">{badgelabel} Badge</h4>
          ...
          <p className="font-manrope font-[400] text-[14px] text-center w-[288px] md:w-[399px]">
            You just unlocked the <span className="capitalize"> {badgelabel}</span> Badge as you have scored{' '}
            {scorePercentage} points or above by completing this assessment.
          </p>
        </div>
